...
let bio = artists[2].bio;
console.log(bio);


/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue 
and console.log() to check your work. */
function fixName(arr, ind, name){
  arr[ind].name = name;
  return arr[ind].name; 
}
...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 4: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
Create a function called get20s() that takes data as an argument and returns an array with names 
of artists who were born in and died in 20th century (1900-2000) example born in 1901 and died 
in 1959 - included / born in 1889 and died in 1925 not included - should return ["Salvador Dali", "Frida Kahlo"]*/
...
console.log(addArtist(artists, 20, 'karla cervantes', '1996-2020', 'Web Design', 'American', 'I am a student. I like being a Lambda student!'));
